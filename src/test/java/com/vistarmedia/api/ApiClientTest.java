...
public class ApiClientTest {
  ...
  public void setUp() {
    ...
    sampleAdRequest = AdRequest.newBuilder()
    .setNetworkId("network-id")
    .setApiKey("api-key")
    .setDeviceId("internal-device-id")
    .setNumberOfScreens(1)
    .setDisplayTime(nowInSeconds)
    .build();
    
    sampleProofOfPlay = ProofOfPlay.newBuilder()
      .setDisplayTimeInSeconds(10)
      .setPlayTime(nowInSeconds)
      .setNumberOfScreens(1)
      .setLeaseId("sample-lease-id")
      .build();
  }
  
  @Test
  public void testSimpleAdResponse() throws InterruptedException, ExecutionException {
    ...
    Future<AdResponseResult> resultFuture = client.sendAdRequest(sampleAdRequest);
  ...
  @Test
  public void testSimpleProofOfPlay() throws InterruptedException, ExecutionException {
    byte[] responseBody = sampleProofOfPlay.toByteArray();
    Transport transport = new SuccessTransport(responseBody);
    ApiClient client = new ApiClient("host", 80, transport);
    
    Future<ProofOfPlayResult> resultFuture = client.sendProofOfPlay(sampleProofOfPlay);
  ...
  @Test
  public void testInvalidResponseBody() throws InterruptedException, ExecutionException {
    ...
    assertThat(error.getMessage(), containsString("the input ended unexpectedly"));
  }
  
  @Test
  public void testResponseTimeout() throws InterruptedException, ExecutionException, TimeoutException {
  ...
  @Test
  public void testRequestError() throws InterruptedException, ExecutionException {
